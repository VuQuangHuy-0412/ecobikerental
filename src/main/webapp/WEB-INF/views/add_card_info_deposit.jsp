	...
	<div class="row">
		<div class="span12" style="margin-left: 40px;">
			...
			<div class="container-fluid row">
				<div class="span12">
					<form method="GET" action="/EcoBikeRental/process-rent" class="" id="formCard">
			...
			<div class="row">
				<div class="span4">&nbsp;</div>
				<div class="span4">
					<button type="submit" form="formCard" style="background-color: darkgray;"><b>Deposit And Rent</b></button>
				</div>
				<div class="span2">&nbsp;</div>
			</div>
		</div>
